...
variable "source_image_1" {
  type        = string
  default     = "centos-stream-8"
  description = "OS family of image for group 1"
}

variable "source_image_2" {
  type        = string
  default     = "ubuntu-2004-lts"
  description = "OS family of image for group 2"
}

variable "useros_1" {
  type        = string
  default     = "cloud-user"
  description = "OS native default user for group 1"
}

variable "useros_2" {
  type        = string
  default     = "ubuntu"
  description = "OS native default user for group 2"
}